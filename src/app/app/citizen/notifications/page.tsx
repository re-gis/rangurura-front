                  ...
                  <p className="text-[90%] relative w-full">
                    ...
                    {!notification.read && (
                      <button
                        ...
                        className="p-2 text-[80%] rounded-xl absolute right-0 bottom-[-0.5rem] bg-gradient-to-tl from-green-300  to-green-100 hover:from-blue-500  flex items-center gap-2"
                      >
                        <MdOutlineMarkEmailRead />
                        Mark as Read
                      </button>
