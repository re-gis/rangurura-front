    ...
    <div className='w-full md:h-[90%] p-8'>
        ...
        <div className='w-full flex flex-col items-center justify-center bg-white rounded-lg md:px-[10vw] h-[90%] mt-10'>
            <div className='w-full flex justify-start gap-10'>
                <Image src={personImg} alt='' width={100} height={100} className='w-1/3 rounded-lg'/>
            ...
            <p className='text-[80%] mt-8'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever</p>
