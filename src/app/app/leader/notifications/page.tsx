      ...
      <div className="w-full h-full">
        ...
        <div className="w-full h-[90%] overflow-y-auto my-4 nofications-container">
            {notifications.map((notification: 
                ...
                return(
                    <div key={index} className={`w-[99%] px-2 py-3 border-l-5 rounded-r-lg ${notification.read ? "bg-[#e5eef9] border-l-[#8a8c8a5b]" : "bg-white border-l-[#00FF00]"} my-2`}>
                        ...
                        <p className="text-[90%] relative w-full">
                            ...
                            {!notification.read &&
                             (
                                <button onClick={()=> markSingleAsRead(notification.id)} className="p-2 text-[80%] rounded-xl absolute right-0 bottom-[-0.5rem] bg-gradient-to-tl from-gray-500  to-gray-200 hover:from-blue-500  flex items-center gap-2">
                                    <MdOutlineMarkEmailRead/>
                                    Mark as Read
                                </button>
                            )}
